...
var total1 = aa1+bb1+cc1+dd1+ee1+ff1+gg1;
console.log(total1);
let total = parseInt(total1, 10);
var score1 = localStorage.getItem("score"); //抓名為score的localStoragea裡的資料
let score = parseInt(score1, 10);
var fin_score = ((score + total)*25/15);
localStorage.setItem("fin_score", fin_score); //設定名為score的localStoragea存入fin_score資料
// alert(total);