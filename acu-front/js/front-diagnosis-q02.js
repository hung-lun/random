...
var total1 = aa1+bb1+cc1+dd1+ee1+ff1+gg1+hh1;
console.log(total1);
let total = parseInt(total1, 10);
localStorage.setItem("score", total); //設定名為score的localStoragea存入total資料
var score = localStorage.getItem("score"); //抓名為score的localStoragea裡的資料
console.log(score);
// alert(total);